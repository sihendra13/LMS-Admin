    ...
    <div className="content">
      <div className="section-header" style={{ marginBottom: '20px' }}>
        ...
        {isSupervisor ? (
          ...
          <button className="btn-primary" onClick={() => { setEditingVideoId(null); setActivePage('upload'); }} style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
          ...
          <button className="btn-primary" style={{ opacity: 0.6, display: 'inline-flex', alignItems: 'center', gap: '8px' }} onClick={() => { setEditingVideoId(null); setActivePage('upload'); }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ color: '#ffffff' }}>
              <line x1="12" y1="5" x2="12" y2="19"></line>
              <line x1="5" y1="12" x2="19" y2="12"></line>
            </svg>
            ...
            draftVideos.length === 0 ? (
              ...
              draftVideos.map((video) => (
                <div key={video.id} className="video-item" style={{ padding: '18px 20px' }}>
                  ...
                  <div className="video-actions" style={{ display: 'flex', gap: '8px', alignItems: 'center', marginLeft: '16px', flexShrink: 0 }}>
                    <button
                      type="button"
