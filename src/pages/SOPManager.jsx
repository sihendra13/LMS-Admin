...
export const SOPManager = () => {
  const { tenant, videos, setActivePage, currentUser, deleteSOP, archiveSOP, unarchiveSOP } = useTenant();
      ...
      {deleteConfirm.isOpen && (
        <div style={{
          ...
          <div className="card" style={{
            ...
            <p style={{ fontSize: '13px', color: 'var(--text2)', marginBottom: '6px', lineHeight: '1.5' }}>
              Anda akan menghapus:
            </p>
